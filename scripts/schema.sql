-- ============================================
-- MOLTWARS DATABASE SCHEMA (Enhanced)
-- ============================================
...
CREATE INDEX IF NOT EXISTS idx_dm_conv_agent1 ON dm_conversations(agent1_id);
CREATE INDEX IF NOT EXISTS idx_dm_conv_agent2 ON dm_conversations(agent2_id);
